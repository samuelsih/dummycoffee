...
<body>
    ...
    ?>
        ...
        <div class="alert alert-success">
            ...
            <strong>You have been logout.</strong>
        </div>
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12 text-center">
                    ...
                    <h1 class="brand-name">Dummy Coffee</h1>
                    <hr class="tagline-divider">
                    <h2>
                        <small>By
                            <strong>Dummy Flash</strong>
                        </small>
                    </h2>
                </div>
            </div>
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    ...
                    For access to unlimited recipes you must register! Registration is free! Click <a href="register.php"><strong>here</strong></a> to get started!
                    </p>
                </div>
            </div>
        </div>
